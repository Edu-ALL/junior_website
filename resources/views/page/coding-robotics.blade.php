...
@section('title', 'Creative Coding & Robotics | EduALL Junior')
                    ...
                    <div class="">
                        <div class="w-full">
                            <h3 class="font-bold text-2xl md:text-3xl">
                                {{ __('coding.what_your_kids_learn_content.0.title') }}
                            </h3>
                        </div>
                    </div>
                    <p class="font-light text-lg text-white mt-4 leading-6">
                        {{ __('coding.what_your_kids_learn_content.0.content') }}
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="mb-10 main-container text-white w-full flex flex-col items-end">
                <div class="w-full md:w-1/2">
                    <div class="">
                        <div class="w-full">
                            <h3 class="font-bold text-2xl md:text-3xl">
                                {{ __('coding.what_your_kids_learn_content.1.title') }}
                            </h3>
                        </div>
                    </div>
                    <p class="font-light text-lg text-white mt-4 leading-6">
                        {{ __('coding.what_your_kids_learn_content.1.content') }}
                    </p>
                </div>
            </div>
        </div>
    ...
    {{-- <section class="bg-orangeBg py-24">
        <div class="main-container">
            <div class="flex flex-col md:flex-row justify-between items-center w-full py-8">
                <h2 class="font-bold text-3xl my-2 md:my-0 text-center">
                    {{ __('coding.learn_more_title') }} <span
                        class="text-orange underline decoration-orangeLight">{{ __('coding.learn_more_highlight') }}</span>
                </h2>
            ...
            <div class="flex flex-wrap items-start justify-center gap-8">
                @foreach (__('coding.learn_more_content') as $content)
                    <x-blog-card :tag="'CODING & ROBOTICS'" :title="$content['title']" :date="'24 July 2024'" :description="$content['description']" :thumbnail="'https://placehold.co/400x300'"
