<nav class="bg-white/0 border-gray-200 dark:bg-gray-900 fixed w-[100%] transition-all duration-300 ease-in-out z-[9999]"
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="{{ url('/' . app()->getLocale()) }}" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img loading="lazy" src="{{ asset('img/logo/EduALL.webp') }}" alt="EduALL Junior" class="w-100 h-14">
        </a>
        ...
        <div class="hidden w-full md:block md:w-auto md:bg-transparent bg-white" id="navbar-default">
            <ul
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                            ...
                            <li>
                                <a href="{{ route('programs.visual-arts', ['locale' => app()->getLocale()]) }}"
                                    class="block px-4 py-2 {{ Route::currentRouteName() == 'programs.visual-arts' ? 'text-primary' : '' }} hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Visual
                                    Arts</a>
                            </li>
                        </ul>
                    </div>
