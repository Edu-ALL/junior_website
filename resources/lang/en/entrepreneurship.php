...
return [
    ...
    'why_entrepreneurship_badge' => 'Why',
    'why_entrepreneurship_title' => 'Why learn Entrepreneurship?',
    'why_entrepreneurship_content' => [
        [
            'title' => 'Future-Proofing Skills',
            'content' => 'With the majority of future jobs yet to be invented, it\'s crucial to equip students with skills that transcend specific roles. An entrepreneurial mindset fosters adaptability, creativity, and a commitment to continuous learning, empowering students to thrive in an ever-changing landscape (IFTF, 2017; Obschonka et al., 2012).',
        ],
        [
    ...
    'why_necessary_content' => [
        [
            'title' => 'Predictive of Future Behaviors',
            'content' => 'Introducing entrepreneurial education at a young age not only cultivates crucial skills but also shapes students\' intentions and aspirations for their future careers. Research demonstrates that entrepreneurial intentions are powerful predictors of future behaviors, highlighting the importance of early exposure to entrepreneurial concepts (Krueger Jr, Reilly, & Carsrud, 2000).',
            'image' => '',
        ],
        [
            'title' => 'Teachability of Entrepreneurial Mindset',
            'content' => 'Contrary to the belief that entrepreneurial mindset is innate, scholars argue that it can be learned and taught. By integrating entrepreneurial education into primary and secondary school curricula, kids can develop the skills and mindset necessary to navigate the complexities of the modern world and contribute to a more productive society (Henry, Hill, & Leitch, 2005; World Economic Forum, 2019).',
            'image' => '',
        ]
    ],
    ...
    'phases_content' => [
        [
            'title' => 'Phase 1',
            'content' => 'Awareness and development'
        ],
        [
            'title' => 'Phase 2',
            'content' => 'Concretization of ideas and Implementation'
        ],
        [
            'title' => 'Phase 3',
            'content' => 'Financial literacy and business'
        ],
    ],
