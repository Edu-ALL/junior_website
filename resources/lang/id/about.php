...
return [
    ...
    'methodology_content' => [
        [
            'content' => 'Program kami dikembangkan dengan melibatkan pengajar lokal dan internasional, psikolog, pakar industri, orang tua, dan anak-anak untuk memastikan bahwa program ini berkualitas tinggi dan relevan dengan kebutuhan saat ini, namun tetap menyenangkan bagi anak-anak. Dengan menggabungkan anak-anak dalam berbagai aktivitas mereka akan mendapatkan gagasan dari berbagai budaya, latar belakang, kemampuan, dan sudut pandang.',
        ],
        [
            'content' => 'Kami membangun kepercayaan diri pada murid melalui kerja sama kolaboratif, menciptakan lingkungan belajar yang positif, dan mendorong evaluasi bersama.',
        ]
    ],
    ...
    'facilities_header' => 'Center baru kami menyediakan suasana hangat dan ramah di mana anak-anak merasa nyaman dan termotivasi untuk belajar, dilengkapi dengan:',
    'facilities_list' => [
        [
            'content' => 'Makerspace',
        ],
        ...
        [
            'content' => 'Perpustakaan Mini ',
        ],
        [
            'content' => 'Ruang Public Speaking',
        ],
        [
            'content' => 'Area Multi Fungsi',
        ]
    ],
    'facilities_description' => 'Kami juga memberikan kesempatan unik kepada anak-anak untuk bermain di alam melalui partisipasi aktif dalam aktivitas fisik dan praktik langsung. Aktivitas pembelajaran kami tidak hanya terjadi di dalam kelas namun juga di luar ruang kelas, sehingga anak-anak dapat menjelajah dan belajar langsung dari lingkungan sekitar mereka.',
];